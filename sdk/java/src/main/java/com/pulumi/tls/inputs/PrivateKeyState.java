...
public final class PrivateKeyState extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    @Import(name="privateKeyPemPkcs8")
    private @Nullable Output<String> privateKeyPemPkcs8;

    /**
     * @return Private key data in [PKCS#8 PEM (RFC 5208)](https://datatracker.ietf.org/doc/html/rfc5208) format.
     * 
     */
    public Optional<Output<String>> privateKeyPemPkcs8() {
        return Optional.ofNullable(this.privateKeyPemPkcs8);
    }
    ...
    private PrivateKeyState(PrivateKeyState $) {
        ...
        this.privateKeyPemPkcs8 = $.privateKeyPemPkcs8;
    ...
    public static final class Builder {
        ...
        /**
         * @param privateKeyPemPkcs8 Private key data in [PKCS#8 PEM (RFC 5208)](https://datatracker.ietf.org/doc/html/rfc5208) format.
         * 
         * @return builder
         * 
         */
        public Builder privateKeyPemPkcs8(@Nullable Output<String> privateKeyPemPkcs8) {
         ...
         * 
         */
        public Builder privateKeyPemPkcs8(String privateKeyPemPkcs8) {
            return privateKeyPemPkcs8(Output.of(privateKeyPemPkcs8));
        }

        /**
         * @param publicKeyFingerprintMd5 The fingerprint of the public key data in OpenSSH MD5 hash format, e.g. `aa:bb:cc:...`. Only available if the selected private key format is compatible, similarly to `publicKeyOpenssh` and the ECDSA P224 limitations.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param publicKeyFingerprintSha256 The fingerprint of the public key data in OpenSSH SHA256 hash format, e.g. `SHA256:...`. Only available if the selected private key format is compatible, similarly to `publicKeyOpenssh` and the ECDSA P224 limitations.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param publicKeyOpenssh The public key data in [&#34;Authorized Keys&#34;](https://www.ssh.com/academy/ssh/authorized_keys/openssh#format-of-the-authorized-keys-file) format. This is not populated for `ECDSA` with curve `P224`, as it is not supported. **NOTE**: the [underlying](https://pkg.go.dev/encoding/pem#Encode) [libraries](https://pkg.go.dev/golang.org/x/crypto/ssh#MarshalAuthorizedKey) that generate this value append a `\n` at the end of the PEM. In case this disrupts your use case, we recommend using `trimspace()`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param publicKeyPem Public key data in [PEM (RFC 1421)](https://datatracker.ietf.org/doc/html/rfc1421) format. **NOTE**: the [underlying](https://pkg.go.dev/encoding/pem#Encode) [libraries](https://pkg.go.dev/golang.org/x/crypto/ssh#MarshalAuthorizedKey) that generate this value append a `\n` at the end of the PEM. In case this disrupts your use case, we recommend using `trimspace()`.
         * 
         * @return builder
         * 
         */
